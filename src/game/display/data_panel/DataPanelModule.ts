...
import {
    PanelTypeReducer,
    PanelTypeReducers,
} from "./PanelReducersRegistry.ts";
import {
    PanelActionImplementation,
    SelectionPanelReducer,
    SelectionPanelReducers,
    createPanelActions,
} from "./PanelAction.ts";
...
export class DataPanelModule extends DisplayModule<GameDisplayContext> {
    ...
    private updatePanel(): void {
        ...
        const reducer: SelectionPanelReducer | undefined =
            SelectionPanelReducers[view.viewDefinition.type];
        const reduced = reducer
            ? reducer(this.activeEntity, this.display.ecs)
            : {};

        const typeReducer: PanelTypeReducer | undefined = baseDef.panelType
            ? PanelTypeReducers[baseDef.panelType]
            : undefined;
        const panelTypeData = typeReducer
            ? typeReducer(this.activeEntity, this.display.ecs)
            : undefined;
