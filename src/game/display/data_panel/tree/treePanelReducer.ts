...
export function treePanelReducer(
    entity: Entity,
    ecs: ECS,
): TreePanelUIData | null {
    ...
    const isBeingCut = !!ecs
        .getComponent(entity, InteractionSlots)
        ?.inUse(SlotType.WORK);
