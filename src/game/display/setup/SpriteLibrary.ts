...
export const TreeAtlasKeys = ['fir0', 'fir1', 'linden0', 'linden1', 'beech0', 'beech1', 'oak0', 'oak1', 'rowan0', 'rowan1', 'birch0', 'birch1', 'cedar0', 'cedar1', 'maple0', 'maple1'] as const;
...
export const plantSpriteToNameAndDescription = {
    tree0: { name: 'Fir Tree', description: 'A tall, evergreen fir tree with dense, dark green needles.' },
    tree1: { name: 'Maple Tree', description: 'A broadleaf maple tree with a bifurcated trunk and vibrant green leaves.' },
    tree2: { name: 'Beech Tree', description: 'A stately beech tree with smooth bark and a full leafy canopy.' },
    tree3: { name: 'Oak Tree', description: 'An ancient oak tree with a sturdy trunk and sprawling branches.' },
    tree4: { name: 'Rowan Tree', description: 'A slender rowan tree with delicate compound leaves.' },
    tree5: { name: 'Birch Tree', description: 'A graceful birch tree with white bark and light, airy foliage.' },
    bush1: { name: 'Natal Plum Bush', description: 'Beauty and bountiful foraging in one lovely shrub' },
    bush0: { name: 'Blueberry Bush', description: 'Lovely shrubberry, much fruit!.' },
} as const;
