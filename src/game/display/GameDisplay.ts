...
export class GameDisplay implements GameDisplayContext {
    ...
    init(scene: Phaser.Scene, ecs: ECS, modules: GameDisplayModule[]) {
        this.scene = scene;
        this.ecs = ecs;
    ...
    private initDisplaySizeRt(scene: Phaser.Scene) {
        this.tintTexture = scene.add.renderTexture(
            0,
            0,
            Config.Display.Width,
            Config.Display.Height,
        ...
        this.tintTexture.camera.setOrigin(
            mainCamera.originX,
            mainCamera.originY,
        );
    ...
    private updateRt() {
        ...
        this.tintTexture.camera.setScroll(
            mainCamera.scrollX,
            mainCamera.scrollY,
        );
