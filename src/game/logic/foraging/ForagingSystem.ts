...
import { CharacterAction, ForagingActionData, ActionDataType } from "../intent/intent-to-action/actionIntentData";
...
export class ForagingSystem extends System {
    ...
    public update(entities: Set<Entity>, deltaMs: number): void {
        ...
        for (const characterEntity of entities) {
            ...
            const baseYieldFromNodeThisFrame = StatCalculator.getEffectiveStat(this.ecs, characterEntity, AffectedStat.FORAGING_SPEED) * gameMinutesPassedThisFrame;
