...
export function useToolCursor(
    ...
    useEffect(() => {
        ...
        if (!gameContainer) {
            console.warn(
                `useToolCursor: Game container with ID "${gameContainerId}" not found.`,
            );
            return;
        }
