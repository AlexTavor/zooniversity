...
export const CharacterPortraitDisplay: React.FC<
    CharacterPortraitDisplayProps
> = ({
    id,
    characterType,
    currentAction,
    ...
    const portraitSrc =
        characterPortraitIconMap[characterType] ||
        "assets/icons/unknown_character.png"; // Fallback
    ...
    return (
        ...
        >
            ...
            {currentAction ? (
                <ActionIconOverlay iconSize={finalActionIconSize}>
                    <ActionIcon
