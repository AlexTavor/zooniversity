...
export const TopCharacterBar: React.FC<TopCharacterBarProps> = ({
    ...
    const [portraitsState, setPortraitsState] = useState<
        Record<string | number, InternalCharacterUIData>
    >({});
    const [globallySelectedCharacterId, setGloballySelectedCharacterId] =
        useState<string | number | null>(null);

    const handleCharacterUpdate = useCallback(
        (data: CharacterUpdateEventPayload) => {
