...
import { TreeHarvestableUIData } from "../../../../../game/display/data_panel/tree/treePanelReducer";
...
export const TimberSection: React.FC<TimberSectionProps> = ({
    ...
    const primaryWoodYield =
        woodYieldData.find((drop) => drop.type === ResourceType.WOOD) ||
        (woodYieldData.length > 0 ? woodYieldData[0] : null);
        ...
        <SectionWrapper>
            ...
            <ContentLine style={{ color: textColor }}>
                ...
                {primaryWoodYield && woodResourceDetails && (
                    <YieldGroup>
                        <LabelText style={{ paddingRight: "8px" }}>
                            Yield
                        </LabelText>
                        <Icon
